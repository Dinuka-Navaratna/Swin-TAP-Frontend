...
const Exterior = ({ exteriorCount, setExteriorCount }) => {
    const [descriptions, setDescriptions] = useState({});

    useEffect(() => {
        setDescriptions(ChecklistData.Exterior);
        setExteriorCount(0 + "/" + Object.keys(ChecklistData.Exterior).length);
    }, []);
    ...
    const checkListUpdate = (event) => {
        ...
        var count = parseInt(exteriorCount.split('/')[0]);
        ...
        setExteriorCount(count + "/" + Object.keys(descriptions).length);
    };
        ...
        <div className="col-md-5 sublists">
            <div className="border pt-3">
                <div className="text-center py-2">
                    <h2 className="py-2">Exterior Checklist</h2>
