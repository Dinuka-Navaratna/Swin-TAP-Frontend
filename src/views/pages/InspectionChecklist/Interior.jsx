...
const Interior = ({ interiorCount, setInteriorCount }) => {
    const [descriptions, setDescriptions] = useState({});

    useEffect(() => {
        setDescriptions(ChecklistData.Interior);
        setInteriorCount(0 + "/" + Object.keys(ChecklistData.Interior).length);
    }, []);
    ...
    const checkListUpdate = (event) => {
        ...
        let count = parseInt(interiorCount.split('/')[0]);
        ...
        setInteriorCount(count + "/" + Object.keys(descriptions).length);
    };
        ...
        <div className="col-md-5 sublists">
            <div className="border pt-3">
                <div className="text-center py-2">
                    <h2 className="py-2">Interior Checklist</h2>
