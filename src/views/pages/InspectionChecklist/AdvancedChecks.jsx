...
const AdvancedChecks = ({ advancedChecksCount, setAdvancedChecksCount }) => {
    const [descriptions, setDescriptions] = useState({});

    useEffect(() => {
        setDescriptions(ChecklistData.AdvancedChecks);
        setAdvancedChecksCount(0 + "/" + Object.keys(ChecklistData.AdvancedChecks).length);
    }, []);
    ...
    const checkListUpdate = (event) => {
        ...
        let count = parseInt(advancedChecksCount.split('/')[0]);
        ...
        setAdvancedChecksCount(count + "/" + Object.keys(descriptions).length);
    };
        ...
        <div className="col-md-5 sublists">
            <div className="border pt-3">
                <div className="text-center py-2">
                    <h2 className="py-2">Advanced Checks Checklist</h2>
