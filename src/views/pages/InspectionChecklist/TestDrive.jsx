...
const TestDrive = ({ testDriveCount, setTestDriveCount }) => {
    const [descriptions, setDescriptions] = useState({});

    useEffect(() => {
        setDescriptions(ChecklistData.TestDrive);
        setTestDriveCount(0 + "/" + Object.keys(ChecklistData.TestDrive).length);
    }, []);
    ...
    const checkListUpdate = (event) => {
        ...
        let count = parseInt(testDriveCount.split('/')[0]);
        ...
        setTestDriveCount(count + "/" + Object.keys(descriptions).length);
    };
        ...
        <div className="col-md-5 sublists">
            <div className="border pt-3">
                <div className="text-center py-2">
                    <h2 className="py-2">Test Drive Checklist</h2>
