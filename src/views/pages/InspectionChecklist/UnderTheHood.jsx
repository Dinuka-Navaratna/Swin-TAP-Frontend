...
const UnderTheHood = ({ underTheHoodCount, setUnderTheHoodCount }) => {
    const [descriptions, setDescriptions] = useState({});

    useEffect(() => {
        setDescriptions(ChecklistData.UnderTheHood);
        setUnderTheHoodCount(0 + "/" + Object.keys(ChecklistData.UnderTheHood).length);
    }, []);
    ...
    const checkListUpdate = (event) => {
        ...
        let count = parseInt(underTheHoodCount.split('/')[0]);
        ...
        setUnderTheHoodCount(count + "/" + Object.keys(descriptions).length);
    };
        ...
        <div className="col-md-5 sublists">
            <div className="border pt-3">
                <div className="text-center py-2">
                    <h2 className="py-2">Under the Hood Checklist</h2>
