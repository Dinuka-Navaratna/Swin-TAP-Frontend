...
const Documentation = ({ documentationCount, setDocumentationCount }) => {
    const [descriptions, setDescriptions] = useState({});

    useEffect(() => {
        setDescriptions(ChecklistData.Documentation);
        setDocumentationCount(0 + "/" + Object.keys(ChecklistData.Documentation).length);
    }, []);
    ...
    const checkListUpdate = (event) => {
        ...
        let count = parseInt(documentationCount.split('/')[0]);
        ...
        setDocumentationCount(count + "/" + Object.keys(descriptions).length);
    };
        ...
        <div className="col-md-5 sublists">
            <div className="border pt-3">
                <div className="text-center py-2">
                    <h2 className="py-2">Documentation Checklist</h2>
